<script src="{{ asset('js/ch2End.js') }}" defer></script>
<script>
    const points = "{{ Auth::user()->points_ch2 }}";
</script>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="row justify-content-center" id="curator-img">
                    <img id="illustration" src="images\pigies\pogi_amuse.png" alt="Piggies" style="height: 230px; width: auto;">
                </div>
                {{-- Dialogue Box --}}
